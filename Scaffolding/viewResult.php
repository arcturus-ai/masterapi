...
if($itemCount > 0){
	...
	while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
		...
		$e = array(
			...
			"Event"            			=> $events,
            "Image"            			=> $image_path,
			"incompletescaffolding" 	=> $incompletescaffolding,
			"withoutscaffolding" 		=> $withoutscaffolding,
			"incorrectclimbingladder" 	=> $incorrectclimbingladder,
			"remark"                    => $remark,
